...
const tryParseJson = require('json-try-parse');
    ...
    constructor(config) {
        ...
        this._request = (method, url, options) => {
            ...
            return new Promise((resolve, reject) => {
                ...
                this.request(url, Object.assign({ method: method, json: (method.toLowerCase() != "get") }, options), (error, response, body) => {
                    if (err) {
                        return reject(err);
                    }
                    ...
                    if(!json){
                        return reject('Unable to parse response from ' + url);
                    }
                    return resolve( json );
                });
